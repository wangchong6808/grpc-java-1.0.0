...
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %ROUTE_GUIDE_SERVER_OPTS%  -classpath "%CLASSPATH%" io.grpc.examples.routeguide.RouteGuideServer %CMD_LINE_ARGS%
...
if  not "" == "%ROUTE_GUIDE_SERVER_EXIT_CONSOLE%" exit 1
exit /b 1
